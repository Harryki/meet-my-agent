  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 sm:p-6">
      <div className="flex h-[85vh] w-full max-w-5xl overflow-hidden rounded-2xl bg-white shadow-2xl">
        {/* 좌측 채팅 히스토리 */}
        <div className="hidden w-64 flex-col border-r border-gray-100 bg-gray-50 sm:flex">
          <div className="flex items-center justify-between border-b border-gray-100 px-4 py-3">
            <p className="font-semibold text-gray-900">채팅 목록</p>
            <button
              onClick={handleNewChat}
              className="rounded-full p-1.5 text-gray-500 transition hover:bg-gray-200 hover:text-gray-700"
              aria-label="새 채팅"
            >
